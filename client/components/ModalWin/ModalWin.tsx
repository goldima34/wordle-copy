...
const ModalWin: React.FC<ModalWinProps> = ({word, attemps}) => {
    const restartClick = () =>{
    ...
    return (
        <div className='Wrapper'>
            <div className="Container">
                <p className="Header">Good job!</p>
                <p className="">Word: <strong>{word}</strong></p>
                <p className="">Attemps: <strong>{attemps}</strong></p>
